 ...
 * Constructor.
 */
KruskalPathCompression::KruskalPathCompression(int n, int m, std::vector<Edge>& edges):n_(n),m_(m),edges_(edges) {
 ...
 * Destructor.
 */
KruskalPathCompression::~KruskalPathCompression() {
}

/**
 * Metodo para obtener el AGM de un grafo
 */
Agm KruskalPathCompression::getAGM() {
    DisjointSetCompression set(n_);
